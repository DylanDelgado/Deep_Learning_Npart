...
c 2*nmax*nmax logical
      ...
      integer spin(nmax),ncoll(nmax),nincoll(nmax),charge(nmax),
...
c 19 real*8
     ...
     +     dectime(nmax), tform(nmax), xtotfac(nmax)
      ...
      common/isys/spin,ncoll,nincoll,charge,ityp,lstcoll,iso3,origin,
     +            uid
...
c     nincoll : particle, number of inelastic collisions
